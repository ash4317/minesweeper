...
if __name__ == "__main__":
    ...
    game = Game()
    grid = Grid(grid_size=grid_size, grid_width=800, cell_size=cell_size)
    ...
    while game.get_run_state():
            ...
            if game.get_status() == "ongoing":
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if pygame.mouse.get_pressed() == (True, False, False):
                        ...
                        cell = grid.reveal_cell(cell_coord_x, cell_coord_y, screen) #Reveal the cell
                        if cell.get_type() == "mine":
                            ...
                            visited_cells = visited_cells.union(grid.reveal_blank_cells((cell_coord_x, cell_coord_y)))
        ...
        grid.draw_grid(screen)  #Draw the grid
        grid.draw_menu(screen, game.get_status())   #Draw the menu
